# sway: the previous compositor, kept as a drop-in alternative to niri. Not in
# the host's aspect list; swap "niri" for "sway" there to bring it back. The
# generic Wayland bits shared with niri are in wayland.nix.
{
      ...
      wayland.windowManager.sway = {
        ...
        config =
          ...
          in
          {
            ...
            output = {
              "BOE 0x0BCA Unknown" = {
                color_profile = "icc ${./_BOE_CQ_______NE135FBM_N41.icm}";
              };
            ...
            input = {
              ...
              "1:1:AT_Translated_Set_2_keyboard" = {
                # caps/escape swap now happens in keyd (hardware/input-devices.nix) so it
                # also applies to apps reading physical scancodes (Bevy/raylib).
                xkb_options = "compose:ralt";
              };
